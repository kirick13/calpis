 ...
 * @typedef {{ module: () => Promise<any>, args: any[] }} CalpisTask
 */

/**
 * Runs a task.
 * @param {CalpisTask} calpisTask -
 * @returns {Promise<{ writable: WritableStream<CalpisFile> | null, readable: ReadableStream<CalpisFile> | null }>} - The writable and readable streams.
 */
